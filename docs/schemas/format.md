...
Formats define **only** how content is structured and delivered. They determine the output medium (text, screenplay, comic, audio, interactive), the structural hierarchy (e.g., book > chapters > scenes), pacing rules, and medium-specific settings.
